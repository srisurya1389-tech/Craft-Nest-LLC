...
const collectionData: Record<string, {
  ...
  painting: {
    ...
    tag: 'FACE PAINTING',
    bannerImg: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779151/WhatsApp_Image_2026-06-18_at_4.02.38_PM_3_npjwar.jpg',
    ...
    filters: [],
    products: [
      { title: 'Rose Petal Cheek Art',      badge: 'Bestseller', desc: 'Soft hand-painted rose petals blooming along the cheekbone — a romantic and feminine design perfect for weddings and garden parties.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779151/WhatsApp_Image_2026-06-18_at_4.02.38_PM_3_npjwar.jpg',   occasion: '' },
      { title: 'Glitter Star Design',       badge: 'Popular',    desc: 'Sparkling multi-colour glitter stars dusted around the eyes — fun, festive, and eye-catching for all ages at any celebration.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779150/WhatsApp_Image_2026-06-18_at_4.02.38_PM_5_v1ks8l.jpg',   occasion: '' },
      { title: 'Indian Festival Art',       badge: 'Festival',   desc: 'Vibrant Indian festival-inspired face art with traditional motifs and bright colours — ideal for cultural events and Navratri celebrations.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779150/WhatsApp_Image_2026-06-18_at_4.02.38_PM_4_wyokds.jpg',   occasion: '' },
      { title: 'Peacock Eye Design',        badge: 'New',        desc: 'Jewel-toned peacock feather fanning from the eye corner with teal, green and gold highlights — a showstopper for ethnic events.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779151/WhatsApp_Image_2026-06-18_at_4.02.39_PM_1_aobbpi.jpg',   occasion: '' },
      { title: 'Floral Cheek Design',       badge: 'Popular',    desc: 'Bright floral cluster painted on the cheek with pastel petals and golden centres — cheerful and delightful for all occasions.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779151/WhatsApp_Image_2026-06-18_at_4.02.38_PM_2_kihgir.jpg',   occasion: '' },
      { title: 'Butterfly Cheek Art',       badge: 'Bestseller', desc: 'Elegant butterfly spread across both cheeks with iridescent wings and fine antenna detail — a timeless favourite for every event.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779151/WhatsApp_Image_2026-06-18_at_4.02.39_PM_po62il.jpg',   occasion: '' },
      { title: 'Crown & Flower Design',     badge: 'New',        desc: 'Ornate crown paired with trailing floral garland — a regal and whimsical combination perfect for princess-themed parties.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779152/WhatsApp_Image_2026-06-18_at_4.02.40_PM_1_fypkcd.jpg',   occasion: '' },
      { title: 'Geometric Eye Art',         badge: 'Adults',     desc: 'Sharp geometric lines and angles framing the eyes with metallic tones — bold, contemporary and perfect for adult parties and festivals.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779151/WhatsApp_Image_2026-06-18_at_4.02.40_PM_4_k4ydik.jpg',   occasion: '' },
      { title: 'Vine Blossom Design',       badge: 'Popular',    desc: 'Winding vine with delicate blossoms curving from the temple to cheekbone — a graceful and artistic design for all celebrations.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779152/WhatsApp_Image_2026-06-18_at_4.02.40_PM_nv6jah.jpg',   occasion: '' },
      { title: 'Rainbow Star Art',          badge: 'Kids',       desc: 'Cheerful rainbow arc with golden stars — a simple, bright and joyful design that every child loves at birthday parties and fairs.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779153/WhatsApp_Image_2026-06-18_at_4.02.41_PM_2_bacyln.jpg',   occasion: '' },
      { title: 'Henna Inspired Design',     badge: 'Festival',   desc: 'Intricate henna-style face art with fine mehndi-inspired patterns painted across the forehead and cheeks — elegant for cultural events.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779164/WhatsApp_Image_2026-06-18_at_4.02.41_PM_1_wzzhps.jpg',   occasion: '' },
      { title: 'Lotus Eye Design',          badge: 'New',        desc: 'Sacred lotus petals radiating from the eye with pink and gold tones — a spiritual and beautiful design for cultural and festive events.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779164/WhatsApp_Image_2026-06-18_at_4.02.41_PM_cvnufq.jpg',   occasion: '' },
      { title: 'Tribal Cheek Art',          badge: 'Popular',    desc: 'Bold tribal stripe design on cheeks with earthy tones and geometric detailing — striking and powerful for themed events and festivals.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779164/WhatsApp_Image_2026-06-18_at_4.02.38_PM_z9jni8.jpg',   occasion: '' },
      { title: 'Glitter Swirl Design',      badge: 'Adults',     desc: 'Flowing swirl patterns in silver and gold glitter curling around the cheekbone — glamorous and sophisticated for evening events.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779165/WhatsApp_Image_2026-06-18_at_4.02.37_PM_nvy09n.jpg',   occasion: '' },
      { title: 'Sparkling Bloom Art',       badge: 'Bestseller', desc: 'Full-cheek bloom painting with vivid petals and glitter accents — a lively, joyful design that suits every age and every occasion.', price: '', img: 'https://res.cloudinary.com/diancfp03/image/upload/e_improve/e_blur_region:700,g_faces/v1781779179/WhatsApp_Image_2026-06-18_at_4.02.38_PM_1_ykpgu8.jpg',   occasion: '' },
    ]
  }
}
